// Logan Meyer, Thomas Klinedinst, Jeffrey Hostetter     EENG 350           Last Modified: 4/25/2021
...
int number_markers = 7;                 //fixme fixme fixme fixme fixme fixme fixme  fixm fixme fixme fixme fixme fixme fixme  fixme fixme fixme fixme fixme fixme  fixme fixme fixme fixme fixme fixme  fixme fixme fixme fixme fixme fixme 
...
float fudge = 0.1; // Correction factor
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  switch (state)
  {
    ...
    case 2: 
         ...
         // }
               if(abs(angularPositionL) >= (abs(goalAngleAngle)-0.2)){
                  loganCSdone = true;
   ...
   case 3:
          ...
          if(distanceRead != 0){ // Once distance changes, indicates Pi sent accurate distance
            distanceToGo = (distanceRead / (float) 12); // Converts Pi distance to feet, stops so right next to marker.
   ...
   case 4:
          ...
          //~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ 
           if (loganCSdone && (marker_counter == 1)) {
              motorSpeedL = 80;
              motorSpeedR = 80; 
   ...
   case 5:
            ...
            motorSpeedL = 0; 
            motorSpeedR =  - (float) 1.9*80;     // Hardcode to turn in circle, scale is the difference in circumference for each wheel 
            ...
            if((piState == 1)  && (marker_counter < number_markers)){
              state = 1;
              IL = 0;                                                                       //  (This could be done with a button/ jumper wire/ Pi communication)
              IR = 0;
              angularPositionL = 0;
            ...
            if(marker_counter == number_markers){
              state = 6;
            }
        break;
