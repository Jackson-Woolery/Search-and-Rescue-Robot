// Logan Meyer, Thomas Klinedinst, Jeffrey Hostetter     EENG 350           Last Modified: 4/30/2021
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  switch (state)
  {
   ...
   case 5:
            ...
            Serial.println("P I S T A T E"); 
            Serial.print(piState); 
            Serial.print(marker_counter);
            Serial.println(number_markers);
            if((piState == 1) && (marker_counter < number_markers)){  
              piState = 0;
              Serial.println("D E T E C T E D!");
              state = 1;
              IL = 0;                                                                       //  (This could be done with a button/ jumper wire/ Pi communication)
              IR = 0;
              angularPositionL = 0;
            ...
            if(marker_counter > number_markers) { 
              Serial.println("TOO MANY MARKERS");
              state = 6;
            }
        break;
       
    case 6:  
        Serial.println("Case 6 --> Stopping");
        motorSpeedL = 0;
        motorSpeedR = 0; // Stops motors
